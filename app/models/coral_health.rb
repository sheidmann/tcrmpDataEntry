...
class CoralHealth < ApplicationRecord
  ...
  def self.as_csv
    columns = %w(coral_health_id proofed site_name date_completed method name rep notes transect_coral_id coral_code_name coral_full_name length_cm width_cm height_cm bl_sp bl_p bl_vp bl_bl old_mortality recent_mortality notes interaction_name interaction_value)
